...
namespace Sample.Service.Utilities
{
    public static class ConvertNPDate
    {
        ...
        public static NepaliDate GetNepaliDate(DateTime enDate)
        {
            ...
            #endregion Core Algorithm for Nepali date conversion
            ...
            npDate.npDate = String.Format("{0}/{1}/{2}", npYear.ToString("00"), npMonth.ToString("00"), npDay.ToString("00"));
            ...
            #endregion Constructing and returning NepaliDate object
        }
        ...
        public static class NepaliDateDataArray
        {
            public static int[] GetNepaliDateDataArray(int year)
            {
                switch (year)
                {
                    ...
                    case 2020:
                        return new int[15] { 2076, 17, 29, 30, 30, 30, 31, 32, 31, 32, 31, 30, 30, 30, 29 };
                    ...
                    case 2024:
                        return new int[15] { 2080, 16, 29, 29, 30, 30, 31, 31, 32, 32, 31, 30, 30, 30, 29 };

                    case 2025:
                        return new int[15] { 2081, 17, 29, 30, 30, 30, 30, 32, 31, 32, 31, 30, 30, 30, 29 };

                    case 2026:
                        return new int[15] { 2082, 17, 29, 30, 30, 30, 31, 31, 32, 31, 31, 30, 30, 30, 29 };
